...
public class MahasiswaDemo14 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++){
            System.out.println("Daftar Mahasiswa ke-" +(i + 1));
            System.out.println("NIM     : " +arrayOfMahasiswa14[i].nim);
            System.out.println("Nama    : " +arrayOfMahasiswa14[i].nama);
            System.out.println("Kelas   : " +arrayOfMahasiswa14[i].kelas);
            System.out.println("IPK     : " +arrayOfMahasiswa14[i].ipk);
            System.out.println("-------------------------------------");
        }
        /*arrayOfMahasiswa14[0] = new Mahasiswa14();
        arrayOfMahasiswa14[0].nim = "2441070600033";
